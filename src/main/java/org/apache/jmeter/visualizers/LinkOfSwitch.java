...
public class LinkOfSwitch {
	...
	public void writeJmx(String switchName) {
		...
		*/
		File temJmx = new File("C:\\apache-jmeter-4.0\\bin\\TopoLinksTem.jmx");
		try {
			...
			temStr = temStr.replaceAll("<stringProp name=\"HTTPSampler.path\">/v1.0/topology/links/0000000000000002</stringProp>",
					"<stringProp name=\"HTTPSampler.path\">/v1.0/topology/links/"+switchName+"</stringProp>");
			File newJmx = new File("C:\\apache-jmeter-4.0\\bin\\TopoLinks"+switchName+".jmx");
			if(newJmx.exists()) {
				newJmx.delete();
			}
	...
	public void writeBatAndRun(String switchName) {
		...
		File newJtl = new File("C:\\apache-jmeter-4.0\\bin\\TopoLinks"+switchName+".jtl");
		File temScript = new File ("C:\\apache-jmeter-4.0\\bin\\bat\\TopoLinksTem.bat");
		File newScript = new File("C:\\apache-jmeter-4.0\\bin\\bat\\ToloLinks"+switchName+".bat");
		if(newJtl.exists()) {
			newJtl.delete();
		}
		if(newScript.exists()) {
	...
	public String readJtl(String switchName ) {
		...
		File jtlFile = new File("C:\\apache-jmeter-4.0\\bin\\TopoLinks"+switchName+".jtl");
		String jtlStr ="" ;
		try {
